...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.message === 'Network Error') {
        setError('Network connection blocked. Please try again.');
      } else {
  ...
  return (
    <div className="min-h-screen bg-[#0B1020] text-white flex flex-col justify-center items-center relative overflow-hidden py-12 px-4 md:px-0">
      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-gray-400 font-medium">Join SecurePay AI today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-gray-500 font-medium ml-1">Must be at least 8 characters</p>
          </div>
